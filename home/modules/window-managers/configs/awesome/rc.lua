...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "cmd", "www", "doc", "talk", "code", "run", "game", "vm", "sys" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn("dmenu_run") end,
              {description = "open dmenu app launcher", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("syncthing serve --no-browser --logfile=default") end,
              {description = "spawn syncthing", group = "launcher"}),
    awful.key({ modkey,           }, "Print", function () awful.spawn.with_shell("sh $HOME/.local/scripts/screenshot") end,
              {description = "make a screenshot with scrot", group = "screen"}),
    awful.key({ modkey, "Shift"   }, "Print", function () awful.spawn.with_shell("sh $HOME/.local/scripts/partial-screenshot") end,
              {description = "make a partial screenshot with scrot", group = "screen"}),

    -- Music controls
    awful.key({ }, "XF86AudioPlay", function () awful.spawn.with_shell("playerctl play-pause") end,
              {description = "Play/pause music", group = "music"}),
    awful.key({ }, "XF86AudioStop", function () awful.spawn.with_shell("playerctl play-pause") end,
              {description = "Play/pause music", group = "music"}),
    awful.key({ }, "XF86AudioNext", function () awful.spawn.with_shell("playerctl next") end,
              {description = "Skip to next song", group = "music"}),
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false } -- enable if titlebars are required
    },
